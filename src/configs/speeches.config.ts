...
export const speeches = {
    ...
    MENTOR_EXISTS_MOBILE: "Mobile already exists",
    ...
    BOARD_REQ: "school board is required.",
    SCHOOL_TYPE_REQ: "school type is required.",
    MANDAL_REQ: "mandal/taluka is required.",
